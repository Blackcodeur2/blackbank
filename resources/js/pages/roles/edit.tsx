...
export default function RoleEdit({ role, permissions }: Props) {
    ...
    return (
        <>
            <Head title={`Modifier ${role.name} — BlackBank`} />
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Modifier {role.name}</h1>
                        <p className="text-sm text-muted-foreground">
                            {data.permissions.length} permission(s) assignée(s)
                        </p>
                    </div>
                </div>
